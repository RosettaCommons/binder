...
void bind_std_stl_deque(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // std::deque file:bits/stl_deque.h line:
		...
		cl.def( pybind11::init( [](unsigned long const & a0){ return new std::deque<int>(a0); } ), "doc" , pybind11::arg("__n"));
		...
		cl.def( pybind11::init<const class std::deque<int> &, const class std::allocator<int> &>(), pybind11::arg("__x"), pybind11::arg("__a") );

		cl.def("assign", (class std::deque<int> & (std::deque<int>::*)(const class std::deque<int> &)) &std::deque<int>::operator=, "C++: std::deque<int>::operator=(const class std::deque<int> &) --> class std::deque<int> &", pybind11::return_value_policy::automatic, pybind11::arg("__x"));
		...
		cl.def("swap", (void (std::deque<int>::*)(class std::deque<int> &)) &std::deque<int>::swap, "C++: std::deque<int>::swap(class std::deque<int> &) --> void", pybind11::arg("__x"));
	...
	{ // std::forward_list file:bits/forward_list.h line:
		...
		cl.def( pybind11::init( [](){ return new std::forward_list<float>(); } ) );
		cl.def( pybind11::init<const class std::allocator<float> &>(), pybind11::arg("__al") );

		cl.def( pybind11::init<const class std::forward_list<float> &, const class std::allocator<float> &>(), pybind11::arg("__list"), pybind11::arg("__al") );
		...
		cl.def("assign", (class std::forward_list<float> & (std::forward_list<float>::*)(const class std::forward_list<float> &)) &std::forward_list<float>::operator=, "C++: std::forward_list<float>::operator=(const class std::forward_list<float> &) --> class std::forward_list<float> &", pybind11::return_value_policy::automatic, pybind11::arg("__list"));
		...
		cl.def("swap", (void (std::forward_list<float>::*)(class std::forward_list<float> &)) &std::forward_list<float>::swap, "C++: std::forward_list<float>::swap(class std::forward_list<float> &) --> void", pybind11::arg("__list"));
		...
		cl.def("merge", (void (std::forward_list<float>::*)(class std::forward_list<float> &)) &std::forward_list<float>::merge, "C++: std::forward_list<float>::merge(class std::forward_list<float> &) --> void", pybind11::arg("__list"));
	...
	{ // std::list file:bits/stl_list.h line:
		...
		cl.def( pybind11::init( [](unsigned long const & a0){ return new std::list<double>(a0); } ), "doc" , pybind11::arg("__n"));
		...
		cl.def( pybind11::init<const class std::list<double> &, const class std::allocator<double> &>(), pybind11::arg("__x"), pybind11::arg("__a") );

		cl.def("assign", (class std::list<double> & (std::list<double>::*)(const class std::list<double> &)) &std::list<double>::operator=, "C++: std::list<double>::operator=(const class std::list<double> &) --> class std::list<double> &", pybind11::return_value_policy::automatic, pybind11::arg("__x"));
		...
		cl.def("swap", (void (std::list<double>::*)(class std::list<double> &)) &std::list<double>::swap, "C++: std::list<double>::swap(class std::list<double> &) --> void", pybind11::arg("__x"));
		...
		cl.def("merge", (void (std::list<double>::*)(class std::list<double> &)) &std::list<double>::merge, "C++: std::list<double>::merge(class std::list<double> &) --> void", pybind11::arg("__x"));
	...
	{ // std::vector file:bits/stl_vector.h line:
		...
		cl.def("begin", (class __gnu_cxx::__normal_iterator<double *, class std::vector<double> > (std::vector<double>::*)()) &std::vector<double>::begin, "C++: std::vector<double>::begin() --> class __gnu_cxx::__normal_iterator<double *, class std::vector<double> >");
		cl.def("end", (class __gnu_cxx::__normal_iterator<double *, class std::vector<double> > (std::vector<double>::*)()) &std::vector<double>::end, "C++: std::vector<double>::end() --> class __gnu_cxx::__normal_iterator<double *, class std::vector<double> >");
		cl.def("cbegin", (class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> > (std::vector<double>::*)() const) &std::vector<double>::cbegin, "C++: std::vector<double>::cbegin() const --> class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >");
		cl.def("cend", (class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> > (std::vector<double>::*)() const) &std::vector<double>::cend, "C++: std::vector<double>::cend() const --> class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >");
		...
		cl.def("insert", (class __gnu_cxx::__normal_iterator<double *, class std::vector<double> > (std::vector<double>::*)(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >, const double &)) &std::vector<double>::insert, "C++: std::vector<double>::insert(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >, const double &) --> class __gnu_cxx::__normal_iterator<double *, class std::vector<double> >", pybind11::arg("__position"), pybind11::arg("__x"));
		cl.def("insert", (class __gnu_cxx::__normal_iterator<double *, class std::vector<double> > (std::vector<double>::*)(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >, unsigned long, const double &)) &std::vector<double>::insert, "C++: std::vector<double>::insert(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >, unsigned long, const double &) --> class __gnu_cxx::__normal_iterator<double *, class std::vector<double> >", pybind11::arg("__position"), pybind11::arg("__n"), pybind11::arg("__x"));
		cl.def("erase", (class __gnu_cxx::__normal_iterator<double *, class std::vector<double> > (std::vector<double>::*)(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >)) &std::vector<double>::erase, "C++: std::vector<double>::erase(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >) --> class __gnu_cxx::__normal_iterator<double *, class std::vector<double> >", pybind11::arg("__position"));
		cl.def("erase", (class __gnu_cxx::__normal_iterator<double *, class std::vector<double> > (std::vector<double>::*)(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >, class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >)) &std::vector<double>::erase, "C++: std::vector<double>::erase(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >, class __gnu_cxx::__normal_iterator<const double *, class std::vector<double> >) --> class __gnu_cxx::__normal_iterator<double *, class std::vector<double> >", pybind11::arg("__first"), pybind11::arg("__last"));
...
void bind_std_stl_vector(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // std::vector file:bits/stl_vector.h line:
		...
		cl.def("begin", (class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > > (std::vector<std::vector<double>>::*)()) &std::vector<std::vector<double>>::begin, "C++: std::vector<std::vector<double>>::begin() --> class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > >");
		cl.def("end", (class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > > (std::vector<std::vector<double>>::*)()) &std::vector<std::vector<double>>::end, "C++: std::vector<std::vector<double>>::end() --> class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > >");
		cl.def("cbegin", (class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > > (std::vector<std::vector<double>>::*)() const) &std::vector<std::vector<double>>::cbegin, "C++: std::vector<std::vector<double>>::cbegin() const --> class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >");
		cl.def("cend", (class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > > (std::vector<std::vector<double>>::*)() const) &std::vector<std::vector<double>>::cend, "C++: std::vector<std::vector<double>>::cend() const --> class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >");
		...
		cl.def("insert", (class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > > (std::vector<std::vector<double>>::*)(class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >, const class std::vector<double> &)) &std::vector<std::vector<double>>::insert, "C++: std::vector<std::vector<double>>::insert(class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >, const class std::vector<double> &) --> class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > >", pybind11::arg("__position"), pybind11::arg("__x"));
		cl.def("insert", (class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > > (std::vector<std::vector<double>>::*)(class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >, unsigned long, const class std::vector<double> &)) &std::vector<std::vector<double>>::insert, "C++: std::vector<std::vector<double>>::insert(class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >, unsigned long, const class std::vector<double> &) --> class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > >", pybind11::arg("__position"), pybind11::arg("__n"), pybind11::arg("__x"));
		cl.def("erase", (class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > > (std::vector<std::vector<double>>::*)(class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >)) &std::vector<std::vector<double>>::erase, "C++: std::vector<std::vector<double>>::erase(class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >) --> class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > >", pybind11::arg("__position"));
		cl.def("erase", (class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > > (std::vector<std::vector<double>>::*)(class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >, class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >)) &std::vector<std::vector<double>>::erase, "C++: std::vector<std::vector<double>>::erase(class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >, class __gnu_cxx::__normal_iterator<const class std::vector<double> *, class std::vector<class std::vector<double> > >) --> class __gnu_cxx::__normal_iterator<class std::vector<double> *, class std::vector<class std::vector<double> > >", pybind11::arg("__first"), pybind11::arg("__last"));
	...
	{ // std::vector file:bits/stl_vector.h line:
		...
		cl.def( pybind11::init<const class std::allocator<class std::vector<class std::vector<double> > > &>(), pybind11::arg("__a") );

		cl.def( pybind11::init( [](unsigned long const & a0){ return new std::vector<std::vector<std::vector<double> >>(a0); } ), "doc" , pybind11::arg("__n"));
		cl.def( pybind11::init<unsigned long, const class std::allocator<class std::vector<class std::vector<double> > > &>(), pybind11::arg("__n"), pybind11::arg("__a") );

		cl.def( pybind11::init( [](unsigned long const & a0, const class std::vector<class std::vector<double> > & a1){ return new std::vector<std::vector<std::vector<double> >>(a0, a1); } ), "doc" , pybind11::arg("__n"), pybind11::arg("__value"));
		cl.def( pybind11::init<unsigned long, const class std::vector<class std::vector<double> > &, const class std::allocator<class std::vector<class std::vector<double> > > &>(), pybind11::arg("__n"), pybind11::arg("__value"), pybind11::arg("__a") );
		...
		cl.def( pybind11::init<const class std::vector<class std::vector<class std::vector<double> > > &, const class std::allocator<class std::vector<class std::vector<double> > > &>(), pybind11::arg("__x"), pybind11::arg("__a") );

		cl.def("assign", (class std::vector<class std::vector<class std::vector<double> > > & (std::vector<std::vector<std::vector<double> >>::*)(const class std::vector<class std::vector<class std::vector<double> > > &)) &std::vector<std::vector<std::vector<double>>>::operator=, "C++: std::vector<std::vector<std::vector<double>>>::operator=(const class std::vector<class std::vector<class std::vector<double> > > &) --> class std::vector<class std::vector<class std::vector<double> > > &", pybind11::return_value_policy::automatic, pybind11::arg("__x"));
		cl.def("assign", (void (std::vector<std::vector<std::vector<double> >>::*)(unsigned long, const class std::vector<class std::vector<double> > &)) &std::vector<std::vector<std::vector<double>>>::assign, "C++: std::vector<std::vector<std::vector<double>>>::assign(unsigned long, const class std::vector<class std::vector<double> > &) --> void", pybind11::arg("__n"), pybind11::arg("__val"));
		cl.def("begin", (class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > > (std::vector<std::vector<std::vector<double> >>::*)()) &std::vector<std::vector<std::vector<double>>>::begin, "C++: std::vector<std::vector<std::vector<double>>>::begin() --> class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >");
		cl.def("end", (class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > > (std::vector<std::vector<std::vector<double> >>::*)()) &std::vector<std::vector<std::vector<double>>>::end, "C++: std::vector<std::vector<std::vector<double>>>::end() --> class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >");
		cl.def("cbegin", (class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > > (std::vector<std::vector<std::vector<double> >>::*)() const) &std::vector<std::vector<std::vector<double>>>::cbegin, "C++: std::vector<std::vector<std::vector<double>>>::cbegin() const --> class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >");
		cl.def("cend", (class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > > (std::vector<std::vector<std::vector<double> >>::*)() const) &std::vector<std::vector<std::vector<double>>>::cend, "C++: std::vector<std::vector<std::vector<double>>>::cend() const --> class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >");
		...
		cl.def("resize", (void (std::vector<std::vector<std::vector<double> >>::*)(unsigned long, const class std::vector<class std::vector<double> > &)) &std::vector<std::vector<std::vector<double>>>::resize, "C++: std::vector<std::vector<std::vector<double>>>::resize(unsigned long, const class std::vector<class std::vector<double> > &) --> void", pybind11::arg("__new_size"), pybind11::arg("__x"));
		...
		cl.def("__getitem__", (class std::vector<class std::vector<double> > & (std::vector<std::vector<std::vector<double> >>::*)(unsigned long)) &std::vector<std::vector<std::vector<double>>>::operator[], "C++: std::vector<std::vector<std::vector<double>>>::operator[](unsigned long) --> class std::vector<class std::vector<double> > &", pybind11::return_value_policy::automatic, pybind11::arg("__n"));
		cl.def("at", (class std::vector<class std::vector<double> > & (std::vector<std::vector<std::vector<double> >>::*)(unsigned long)) &std::vector<std::vector<std::vector<double>>>::at, "C++: std::vector<std::vector<std::vector<double>>>::at(unsigned long) --> class std::vector<class std::vector<double> > &", pybind11::return_value_policy::automatic, pybind11::arg("__n"));
		cl.def("front", (class std::vector<class std::vector<double> > & (std::vector<std::vector<std::vector<double> >>::*)()) &std::vector<std::vector<std::vector<double>>>::front, "C++: std::vector<std::vector<std::vector<double>>>::front() --> class std::vector<class std::vector<double> > &", pybind11::return_value_policy::automatic);
		cl.def("back", (class std::vector<class std::vector<double> > & (std::vector<std::vector<std::vector<double> >>::*)()) &std::vector<std::vector<std::vector<double>>>::back, "C++: std::vector<std::vector<std::vector<double>>>::back() --> class std::vector<class std::vector<double> > &", pybind11::return_value_policy::automatic);
		cl.def("data", (class std::vector<class std::vector<double> > * (std::vector<std::vector<std::vector<double> >>::*)()) &std::vector<std::vector<std::vector<double>>>::data, "C++: std::vector<std::vector<std::vector<double>>>::data() --> class std::vector<class std::vector<double> > *", pybind11::return_value_policy::automatic);
		cl.def("push_back", (void (std::vector<std::vector<std::vector<double> >>::*)(const class std::vector<class std::vector<double> > &)) &std::vector<std::vector<std::vector<double>>>::push_back, "C++: std::vector<std::vector<std::vector<double>>>::push_back(const class std::vector<class std::vector<double> > &) --> void", pybind11::arg("__x"));
		...
		cl.def("insert", (class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > > (std::vector<std::vector<std::vector<double> >>::*)(class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >, const class std::vector<class std::vector<double> > &)) &std::vector<std::vector<std::vector<double>>>::insert, "C++: std::vector<std::vector<std::vector<double>>>::insert(class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >, const class std::vector<class std::vector<double> > &) --> class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >", pybind11::arg("__position"), pybind11::arg("__x"));
		cl.def("insert", (class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > > (std::vector<std::vector<std::vector<double> >>::*)(class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >, unsigned long, const class std::vector<class std::vector<double> > &)) &std::vector<std::vector<std::vector<double>>>::insert, "C++: std::vector<std::vector<std::vector<double>>>::insert(class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >, unsigned long, const class std::vector<class std::vector<double> > &) --> class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >", pybind11::arg("__position"), pybind11::arg("__n"), pybind11::arg("__x"));
		cl.def("erase", (class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > > (std::vector<std::vector<std::vector<double> >>::*)(class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >)) &std::vector<std::vector<std::vector<double>>>::erase, "C++: std::vector<std::vector<std::vector<double>>>::erase(class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >) --> class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >", pybind11::arg("__position"));
		cl.def("erase", (class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > > (std::vector<std::vector<std::vector<double> >>::*)(class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >, class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >)) &std::vector<std::vector<std::vector<double>>>::erase, "C++: std::vector<std::vector<std::vector<double>>>::erase(class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >, class __gnu_cxx::__normal_iterator<const class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >) --> class __gnu_cxx::__normal_iterator<class std::vector<class std::vector<double> > *, class std::vector<class std::vector<class std::vector<double> > > >", pybind11::arg("__first"), pybind11::arg("__last"));
		cl.def("swap", (void (std::vector<std::vector<std::vector<double> >>::*)(class std::vector<class std::vector<class std::vector<double> > > &)) &std::vector<std::vector<std::vector<double>>>::swap, "C++: std::vector<std::vector<std::vector<double>>>::swap(class std::vector<class std::vector<class std::vector<double> > > &) --> void", pybind11::arg("__x"));
...
void bind_std_stl_vector_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // std::vector file:bits/stl_vector.h line:
		...
		cl.def( pybind11::init<const class std::allocator<class std::list<class std::forward_list<class std::deque<double> > > > &>(), pybind11::arg("__a") );
		...
		cl.def( pybind11::init<unsigned long, const class std::allocator<class std::list<class std::forward_list<class std::deque<double> > > > &>(), pybind11::arg("__n"), pybind11::arg("__a") );
		...
		cl.def( pybind11::init<const class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > &, const class std::allocator<class std::list<class std::forward_list<class std::deque<double> > > > &>(), pybind11::arg("__x"), pybind11::arg("__a") );

		cl.def("assign", (class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > & (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)(const class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > &)) &std::vector<std::list<std::forward_list<std::deque<double>>>>::operator=, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::operator=(const class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > &) --> class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > &", pybind11::return_value_policy::automatic, pybind11::arg("__x"));
		cl.def("begin", (class __gnu_cxx::__normal_iterator<class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > > (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)()) &std::vector<std::list<std::forward_list<std::deque<double>>>>::begin, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::begin() --> class __gnu_cxx::__normal_iterator<class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >");
		cl.def("end", (class __gnu_cxx::__normal_iterator<class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > > (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)()) &std::vector<std::list<std::forward_list<std::deque<double>>>>::end, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::end() --> class __gnu_cxx::__normal_iterator<class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >");
		cl.def("cbegin", (class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > > (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)() const) &std::vector<std::list<std::forward_list<std::deque<double>>>>::cbegin, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::cbegin() const --> class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >");
		cl.def("cend", (class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > > (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)() const) &std::vector<std::list<std::forward_list<std::deque<double>>>>::cend, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::cend() const --> class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >");
		...
		cl.def("__getitem__", (class std::list<class std::forward_list<class std::deque<double> > > & (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)(unsigned long)) &std::vector<std::list<std::forward_list<std::deque<double>>>>::operator[], "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::operator[](unsigned long) --> class std::list<class std::forward_list<class std::deque<double> > > &", pybind11::return_value_policy::automatic, pybind11::arg("__n"));
		cl.def("at", (class std::list<class std::forward_list<class std::deque<double> > > & (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)(unsigned long)) &std::vector<std::list<std::forward_list<std::deque<double>>>>::at, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::at(unsigned long) --> class std::list<class std::forward_list<class std::deque<double> > > &", pybind11::return_value_policy::automatic, pybind11::arg("__n"));
		cl.def("front", (class std::list<class std::forward_list<class std::deque<double> > > & (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)()) &std::vector<std::list<std::forward_list<std::deque<double>>>>::front, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::front() --> class std::list<class std::forward_list<class std::deque<double> > > &", pybind11::return_value_policy::automatic);
		cl.def("back", (class std::list<class std::forward_list<class std::deque<double> > > & (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)()) &std::vector<std::list<std::forward_list<std::deque<double>>>>::back, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::back() --> class std::list<class std::forward_list<class std::deque<double> > > &", pybind11::return_value_policy::automatic);
		...
		cl.def("erase", (class __gnu_cxx::__normal_iterator<class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > > (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)(class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >)) &std::vector<std::list<std::forward_list<std::deque<double>>>>::erase, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::erase(class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >) --> class __gnu_cxx::__normal_iterator<class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >", pybind11::arg("__position"));
		cl.def("erase", (class __gnu_cxx::__normal_iterator<class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > > (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)(class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >, class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >)) &std::vector<std::list<std::forward_list<std::deque<double>>>>::erase, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::erase(class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >, class __gnu_cxx::__normal_iterator<const class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >) --> class __gnu_cxx::__normal_iterator<class std::list<class std::forward_list<class std::deque<double> > > *, class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > >", pybind11::arg("__first"), pybind11::arg("__last"));
		cl.def("swap", (void (std::vector<std::list<std::forward_list<std::deque<double> > >>::*)(class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > &)) &std::vector<std::list<std::forward_list<std::deque<double>>>>::swap, "C++: std::vector<std::list<std::forward_list<std::deque<double>>>>::swap(class std::vector<class std::list<class std::forward_list<class std::deque<double> > > > &) --> void", pybind11::arg("__x"));
...
{
	// foo(class std::list<double>) file:T42.stl.names.hpp line:
	M("").def("foo", (void (*)(class std::list<double>)) &foo, "C++: foo(class std::list<double>) --> void", pybind11::arg(""));

	// foo(class std::forward_list<float>) file:T42.stl.names.hpp line:
	M("").def("foo", (void (*)(class std::forward_list<float>)) &foo, "C++: foo(class std::forward_list<float>) --> void", pybind11::arg(""));

	// foo(class std::vector<double>) file:T42.stl.names.hpp line:
	M("").def("foo", (void (*)(class std::vector<double>)) &foo, "C++: foo(class std::vector<double>) --> void", pybind11::arg(""));

	// foo(class std::deque<int>) file:T42.stl.names.hpp line:
	M("").def("foo", (void (*)(class std::deque<int>)) &foo, "C++: foo(class std::deque<int>) --> void", pybind11::arg(""));

	// foo(class std::vector<class std::vector<double> >) file:T42.stl.names.hpp line:
	M("").def("foo", (void (*)(class std::vector<class std::vector<double> >)) &foo, "C++: foo(class std::vector<class std::vector<double> >) --> void", pybind11::arg(""));

	// foo(class std::vector<class std::vector<class std::vector<double> > >) file:T42.stl.names.hpp line:
	M("").def("foo", (void (*)(class std::vector<class std::vector<class std::vector<double> > >)) &foo, "C++: foo(class std::vector<class std::vector<class std::vector<double> > >) --> void", pybind11::arg(""));

	// foo(class std::vector<class std::list<class std::forward_list<class std::deque<double> > > >) file:T42.stl.names.hpp line:
	M("").def("foo", (void (*)(class std::vector<class std::list<class std::forward_list<class std::deque<double> > > >)) &foo, "C++: foo(class std::vector<class std::list<class std::forward_list<class std::deque<double> > > >) --> void", pybind11::arg(""));
