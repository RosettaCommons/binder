...
{
	// test_include_stl(class std::vector<int>, class std::deque<int>, class std::list<int>, struct std::array<int, 5>, class std::valarray<int>, class std::set<int>, class std::unordered_set<int>, class std::map<int, int>, class std::unordered_map<int, int>) file:T43.stl.pybind11_include_stl.hpp line:
	M("").def("test_include_stl", (void (*)(class std::vector<int>, class std::deque<int>, class std::list<int>, struct std::array<int, 5>, class std::valarray<int>, class std::set<int>, class std::unordered_set<int>, class std::map<int, int>, class std::unordered_map<int, int>)) &test_include_stl, "C++: test_include_stl(class std::vector<int>, class std::deque<int>, class std::list<int>, struct std::array<int, 5>, class std::valarray<int>, class std::set<int>, class std::unordered_set<int>, class std::map<int, int>, class std::unordered_map<int, int>) --> void", pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""));
