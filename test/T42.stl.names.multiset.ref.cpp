...
void bind_std_functional_hash(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // std::unordered_multiset file:bits/unordered_set.h line:698
...
{
	// foo(class std::multiset<float, struct std::less<float>, class std::allocator<float> >) file:T42.stl.names.multiset.hpp line:29
	...
	// foo(class std::unordered_multiset<float, struct std::hash<float>, struct std::equal_to<float>, class std::allocator<float> >) file:T42.stl.names.multiset.hpp line:33
