...
#include <msgpack/v1/object_fwd.hpp> // msgpack::v1::type_error
...
void bind_msgpack_v1_object_fwd(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // msgpack::v1::object file:msgpack/v1/object_fwd.hpp line:75
		...
		{ // msgpack::v1::object::union_type file:msgpack/v1/object_fwd.hpp line:76
