...
void bind_unknown_unknown_3(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // msgpack::v2::object file: line:23
		...
		cl.def("convert", (wchar_t & (msgpack::v2::object::*)(wchar_t &) const) &msgpack::v2::object::convert<wchar_t>, "C++: msgpack::v2::object::convert(wchar_t &) const --> wchar_t &", pybind11::return_value_policy::automatic, pybind11::arg("v"));
...
void bind_mmtf_structure_data(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mmtf::Entity file:mmtf/structure_data.hpp line:83
		...
		cl.def("msgpack_object", (void (mmtf::Entity::*)(struct msgpack::v2::object *, class msgpack::v1::zone &) const) &mmtf::Entity::msgpack_object<msgpack::v2::object>, "C++: mmtf::Entity::msgpack_object(struct msgpack::v2::object *, class msgpack::v1::zone &) const --> void", pybind11::arg("msgpack_o"), pybind11::arg("msgpack_z"));
		...
		cl.def("msgpack_unpack", (void (mmtf::Entity::*)(const struct msgpack::v2::object &)) &mmtf::Entity::msgpack_unpack, "C++: mmtf::Entity::msgpack_unpack(const struct msgpack::v2::object &) --> void", pybind11::arg("msgpack_o"));
	...
	{ // mmtf::Transform file:mmtf/structure_data.hpp line:109
		...
		cl.def("msgpack_object", (void (mmtf::Transform::*)(struct msgpack::v2::object *, class msgpack::v1::zone &) const) &mmtf::Transform::msgpack_object<msgpack::v2::object>, "C++: mmtf::Transform::msgpack_object(struct msgpack::v2::object *, class msgpack::v1::zone &) const --> void", pybind11::arg("msgpack_o"), pybind11::arg("msgpack_z"));
		...
		cl.def("msgpack_unpack", (void (mmtf::Transform::*)(const struct msgpack::v2::object &)) &mmtf::Transform::msgpack_unpack, "C++: mmtf::Transform::msgpack_unpack(const struct msgpack::v2::object &) --> void", pybind11::arg("msgpack_o"));
	...
	{ // mmtf::BioAssembly file:mmtf/structure_data.hpp line:132
		...
		cl.def("msgpack_object", (void (mmtf::BioAssembly::*)(struct msgpack::v2::object *, class msgpack::v1::zone &) const) &mmtf::BioAssembly::msgpack_object<msgpack::v2::object>, "C++: mmtf::BioAssembly::msgpack_object(struct msgpack::v2::object *, class msgpack::v1::zone &) const --> void", pybind11::arg("msgpack_o"), pybind11::arg("msgpack_z"));
		...
		cl.def("msgpack_unpack", (void (mmtf::BioAssembly::*)(const struct msgpack::v2::object &)) &mmtf::BioAssembly::msgpack_unpack, "C++: mmtf::BioAssembly::msgpack_unpack(const struct msgpack::v2::object &) --> void", pybind11::arg("msgpack_o"));
	...
	// mmtf::getDefaultValue() file:mmtf/structure_data.hpp line:406
	M("mmtf").def("getDefaultValue", (float (*)()) &mmtf::getDefaultValue<float>, "C++: mmtf::getDefaultValue() --> float");

	// mmtf::isDefaultValue(const class std::vector<signed char, class std::allocator<signed char> > &) file:mmtf/structure_data.hpp line:409
	...
	// mmtf::isDefaultValue(const class std::vector<int, class std::allocator<int> > &) file:mmtf/structure_data.hpp line:409
	...
	// mmtf::isDefaultValue(const class std::vector<std::string, class std::allocator<std::string > > &) file:mmtf/structure_data.hpp line:409
	...
	// mmtf::isDefaultValue(const class std::vector<char, class std::allocator<char> > &) file:mmtf/structure_data.hpp line:409
	...
	// mmtf::isDefaultValue(const class std::vector<float, class std::allocator<float> > &) file:mmtf/structure_data.hpp line:409
	...
	// mmtf::isDefaultValue(const float &) file:mmtf/structure_data.hpp line:409
...
// File: mmtf/structure_data_1.cpp
#include <functional> // std::less
#include <iterator> // __gnu_cxx::__normal_iterator
#include <map> // std::_Rb_tree_const_iterator
#include <map> // std::_Rb_tree_iterator
...
{
	// mmtf::isDefaultValue(const class std::vector<struct mmtf::BioAssembly, class std::allocator<struct mmtf::BioAssembly> > &) file:mmtf/structure_data.hpp line:409
	...
	// mmtf::isDefaultValue(const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &) file:mmtf/structure_data.hpp line:409
	...
	// mmtf::isDefaultValue(const class std::vector<class std::vector<float, class std::allocator<float> >, class std::allocator<class std::vector<float, class std::allocator<float> > > > &) file:mmtf/structure_data.hpp line:409
	...
	// mmtf::isDefaultValue(const class std::vector<signed char, class std::allocator<signed char> > &) file:mmtf/structure_data.hpp line:413
	...
	// mmtf::isDefaultValue(const class std::vector<int, class std::allocator<int> > &) file:mmtf/structure_data.hpp line:413
	...
	// mmtf::isDefaultValue(const class std::vector<std::string, class std::allocator<std::string > > &) file:mmtf/structure_data.hpp line:413
	...
	// mmtf::isDefaultValue(const class std::vector<char, class std::allocator<char> > &) file:mmtf/structure_data.hpp line:413
	...
	// mmtf::isDefaultValue(const class std::vector<float, class std::allocator<float> > &) file:mmtf/structure_data.hpp line:413
	...
	// mmtf::isDefaultValue(const class std::vector<struct mmtf::BioAssembly, class std::allocator<struct mmtf::BioAssembly> > &) file:mmtf/structure_data.hpp line:413
	...
	// mmtf::isDefaultValue(const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &) file:mmtf/structure_data.hpp line:413
	...
	// mmtf::isDefaultValue(const class std::vector<class std::vector<float, class std::allocator<float> >, class std::allocator<class std::vector<float, class std::allocator<float> > > > &) file:mmtf/structure_data.hpp line:413
	...
	// mmtf::isDefaultValue(const std::string &) file:mmtf/structure_data.hpp line:278
	...
	// mmtf::isDefaultValue(const class std::map<std::string, struct msgpack::v2::object, struct std::less<std::string >, class std::allocator<struct std::pair<const std::string, struct msgpack::v2::object> > > &) file:mmtf/structure_data.hpp line:280
	...
	// mmtf::setDefaultValue(float &) file:mmtf/structure_data.hpp line:426
	M("mmtf").def("setDefaultValue", (void (*)(float &)) &mmtf::setDefaultValue<float>, "C++: mmtf::setDefaultValue(float &) --> void", pybind11::arg("value"));

	// mmtf::is_polymer(const unsigned int, const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &) file:mmtf/structure_data.hpp line:298
	...
	// mmtf::is_hetatm(const char *) file:mmtf/structure_data.hpp line:314
	...
	// mmtf::is_hetatm(const unsigned int, const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &, const struct mmtf::GroupType &) file:mmtf/structure_data.hpp line:334
	...
	{ // mmtf::MapDecoder file:mmtf/map_decoder.hpp line:30
		...
		cl.def( pybind11::init<const class std::map<std::string, struct msgpack::v2::object, struct std::less<std::string >, class std::allocator<struct std::pair<const std::string, struct msgpack::v2::object> > > &>(), pybind11::arg("map_in") );
		...
		cl.def("copy_decode", (void (mmtf::MapDecoder::*)(const std::string &, bool, class std::map<std::string, struct msgpack::v2::object, struct std::less<std::string >, class std::allocator<struct std::pair<const std::string, struct msgpack::v2::object> > > &, class msgpack::v1::zone &)) &mmtf::MapDecoder::copy_decode, "Don't decode, but instead just copy map-contents onto a zone\n        for later decoding/processing you should use this when you have\n        nested msgpack objects.\n        Note: There is some copy overhead here. If speed becomes an issue\n              we should come up with a way to keep the original handle alive.\n \n\n      Key into msgpack map.\n \n\n True if field is required by MMTF specs or you\n \n\n   std::map<std::string, msgpack::object> that holds access to data on zone.\n \n\n     msgpack::zone to copy data onto\n\n If msgpack type is not as expected, we write a warning to stderr.\n If conversion to the target type fails, msgpack throws an exception.\n If a required field is missing in the map or if binary decoding fails,\n we throw an mmtf::DecodeError.\n\nC++: mmtf::MapDecoder::copy_decode(const std::string &, bool, class std::map<std::string, struct msgpack::v2::object, struct std::less<std::string >, class std::allocator<struct std::pair<const std::string, struct msgpack::v2::object> > > &, class msgpack::v1::zone &) --> void", pybind11::arg("key"), pybind11::arg("required"), pybind11::arg("target"), pybind11::arg("zone"));
...
#include <mmtf/decoder.hpp> // mmtf::decodeFromStream
#include <mmtf/structure_data.hpp> // mmtf::StructureData
#include <string> // std::__cxx11::basic_string
#include <string> // std::char_traits
...
{
	// mmtf::decodeFromBuffer(struct mmtf::StructureData &, const char *, unsigned long) file:mmtf/decoder.hpp line:34
	...
	// mmtf::decodeFromStream(struct mmtf::StructureData &, class std::basic_ifstream<char> &) file:mmtf/decoder.hpp line:71
	...
	// mmtf::decodeFromFile(struct mmtf::StructureData &, const std::string &) file:mmtf/decoder.hpp line:55
...
void bind_mmtf_binary_encoder(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// mmtf::encodeToStream(const struct mmtf::StructureData &, class std::basic_ofstream<char> &, int, int, int) file:mmtf/encoder.hpp line:50
	...
	// mmtf::encodeToMap(const struct mmtf::StructureData &, class msgpack::v1::zone &, int, int, int) file:mmtf/encoder.hpp line:64
