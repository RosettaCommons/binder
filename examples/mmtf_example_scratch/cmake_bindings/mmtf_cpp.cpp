...
// File: std/postypes.cpp
#include <bits/types/__mbstate_t.h> // (anonymous)
...
#include <forward_list> // std::_Fwd_list_iterator
#include <functional> // std::_Select1st
...
#include <locale> // std::codecvt_base
#include <locale> // std::codecvt_byname
#include <locale> // std::locale
#include <memory> // std::allocator
...
#include <mmtf/structure_data.hpp> // mmtf::Entity
#include <mmtf/structure_data.hpp> // mmtf::GroupType
#include <mmtf/structure_data.hpp> // mmtf::StructureData
#include <mmtf/structure_data.hpp> // mmtf::Transform
#include <mmtf/structure_data.hpp> // mmtf::getDefaultValue
#include <mmtf/structure_data.hpp> // mmtf::getVersionString
#include <mmtf/structure_data.hpp> // mmtf::isDefaultValue
#include <mmtf/structure_data.hpp> // mmtf::isVersionSupported
#include <mmtf/structure_data.hpp> // mmtf::is_hetatm
#include <mmtf/structure_data.hpp> // mmtf::is_polymer
#include <mmtf/structure_data.hpp> // mmtf::setDefaultValue
#include <sstream> // __str__
#include <string> // std::__cxx11::basic_string
#include <string> // std::char_traits
#include <utility> // std::pair
...
void bind_mmtf_structure_data(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// mmtf::isVersionSupported(const std::string &) file:mmtf/structure_data.hpp line:46
	...
	{ // mmtf::GroupType file:mmtf/structure_data.hpp line:53
	...
	{ // mmtf::Entity file:mmtf/structure_data.hpp line:83
	...
	{ // mmtf::Transform file:mmtf/structure_data.hpp line:109
	...
	{ // mmtf::BioAssembly file:mmtf/structure_data.hpp line:132
	...
	msgpack_sd_binder(M("mmtf"));

	// mmtf::getDefaultValue() file:mmtf/structure_data.hpp line:411
	M("mmtf").def("getDefaultValue", (float (*)()) &mmtf::getDefaultValue<float>, "C++: mmtf::getDefaultValue() --> float");

	// mmtf::isDefaultValue(const class std::vector<signed char, class std::allocator<signed char> > &) file:mmtf/structure_data.hpp line:414
	...
	// mmtf::isDefaultValue(const class std::vector<int, class std::allocator<int> > &) file:mmtf/structure_data.hpp line:414
	...
	// mmtf::isDefaultValue(const class std::vector<std::string, class std::allocator<std::string > > &) file:mmtf/structure_data.hpp line:414
	...
	// mmtf::isDefaultValue(const class std::vector<char, class std::allocator<char> > &) file:mmtf/structure_data.hpp line:414
	...
	// mmtf::isDefaultValue(const class std::vector<float, class std::allocator<float> > &) file:mmtf/structure_data.hpp line:414
	...
	// mmtf::isDefaultValue(const float &) file:mmtf/structure_data.hpp line:414
	...
	// mmtf::isDefaultValue(const class std::vector<struct mmtf::BioAssembly, class std::allocator<struct mmtf::BioAssembly> > &) file:mmtf/structure_data.hpp line:414
	...
	// mmtf::isDefaultValue(const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &) file:mmtf/structure_data.hpp line:414
	...
	// mmtf::isDefaultValue(const class std::vector<class std::vector<float, class std::allocator<float> >, class std::allocator<class std::vector<float, class std::allocator<float> > > > &) file:mmtf/structure_data.hpp line:414
	...
	// mmtf::isDefaultValue(const class std::vector<signed char, class std::allocator<signed char> > &) file:mmtf/structure_data.hpp line:418
	...
	// mmtf::isDefaultValue(const class std::vector<int, class std::allocator<int> > &) file:mmtf/structure_data.hpp line:418
	...
	// mmtf::isDefaultValue(const class std::vector<std::string, class std::allocator<std::string > > &) file:mmtf/structure_data.hpp line:418
	...
	// mmtf::isDefaultValue(const class std::vector<char, class std::allocator<char> > &) file:mmtf/structure_data.hpp line:418
	...
	// mmtf::isDefaultValue(const class std::vector<float, class std::allocator<float> > &) file:mmtf/structure_data.hpp line:418
	...
	// mmtf::isDefaultValue(const class std::vector<struct mmtf::BioAssembly, class std::allocator<struct mmtf::BioAssembly> > &) file:mmtf/structure_data.hpp line:418
	...
	// mmtf::isDefaultValue(const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &) file:mmtf/structure_data.hpp line:418
	...
	// mmtf::isDefaultValue(const class std::vector<class std::vector<float, class std::allocator<float> >, class std::allocator<class std::vector<float, class std::allocator<float> > > > &) file:mmtf/structure_data.hpp line:418
	...
	// mmtf::isDefaultValue(const std::string &) file:mmtf/structure_data.hpp line:283
	...
	// mmtf::setDefaultValue(float &) file:mmtf/structure_data.hpp line:431
	M("mmtf").def("setDefaultValue", (void (*)(float &)) &mmtf::setDefaultValue<float>, "C++: mmtf::setDefaultValue(float &) --> void", pybind11::arg("value"));

	// mmtf::is_polymer(const unsigned int, const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &) file:mmtf/structure_data.hpp line:303
	M("mmtf").def("is_polymer", (bool (*)(const unsigned int, const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &)) &mmtf::is_polymer, "Check if chain is a polymer chain.\n \n\n  Chain index of chain.\n \n\n  StructureData.entityList with info on given chain.\n \n\n True if chain is a polymer chain.\n \n\n mmtf::DecodeError if chain index doesn't appear in entity list.\n\nC++: mmtf::is_polymer(const unsigned int, const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &) --> bool", pybind11::arg("chain_index"), pybind11::arg("entity_list"));

	// mmtf::is_hetatm(const char *) file:mmtf/structure_data.hpp line:319
	M("mmtf").def("is_hetatm", (bool (*)(const char *)) &mmtf::is_hetatm, "Check if group type consists of HETATM atoms.\n \n\n   Character string of GroupType.chemCompType.\n \n\n True if group consists of HETATM atoms.\n\n Relevant threads:\n - https://github.com/rcsb/mmtf/issues/28\n - http://mmcif.wwpdb.org/dictionaries/mmcif_pdbx_v50.dic/Items/_chem_comp.type.html\n\n \n Use the other is_hetatm function whenever possible. This one should\n          only be used if you don't have info like an 'entity_list' to work\n          with. This can return 'false' if you have an amino acid ligand.\n\nC++: mmtf::is_hetatm(const char *) --> bool", pybind11::arg("type"));

	// mmtf::is_hetatm(const unsigned int, const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &, const struct mmtf::GroupType &) file:mmtf/structure_data.hpp line:339
	M("mmtf").def("is_hetatm", (bool (*)(const unsigned int, const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &, const struct mmtf::GroupType &)) &mmtf::is_hetatm, "Preferred way to check if group consists of hetatm atoms.\n \n\n  Chain index of chain where atom belongs to.\n \n\n  StructureData.entityList with info on given chain.\n \n\n   GroupType of group where atom belongs to.\n \n\n True if it is a HETATM.\n\n Follows discussion in https://github.com/rcsb/mmtf/issues/28.\n\n Used in StructureData.print to mark atoms as HETATM. This is a shorthand for\n `is_hetatm(type) || !is_polymer(chain_index, entity_list)`.\n\n Efficient code needing this information should preferably use the or\n statement above, precompute the `is_polymer` output for each chain and the\n `is_hetatm(type)` output for each group instead of calling this on each atom.\n\n \n is_polymer, is_hetatm\n\nC++: mmtf::is_hetatm(const unsigned int, const class std::vector<struct mmtf::Entity, class std::allocator<struct mmtf::Entity> > &, const struct mmtf::GroupType &) --> bool", pybind11::arg("chain_index"), pybind11::arg("entity_list"), pybind11::arg("group_type"));

}


// File: mmtf/binary_decoder.cpp
#include <functional> // std::less
#include <iterator> // __gnu_cxx::__normal_iterator
#include <map> // std::_Rb_tree_const_iterator
#include <map> // std::_Rb_tree_iterator
...
{
	{ // mmtf::BinaryDecoder file:mmtf/binary_decoder.hpp line:30
	...
	{ // mmtf::MapDecoder file:mmtf/map_decoder.hpp line:31
		...
		cl.def( pybind11::init( [](){ return new mmtf::MapDecoder(); } ) );
		...
		cl.def("initFromBuffer", (void (mmtf::MapDecoder::*)(const char *, unsigned long)) &mmtf::MapDecoder::initFromBuffer, "Initialize from byte buffer of given size.\n Unpacks data and then same effect as MapDecoder::initFromObject.\n\nC++: mmtf::MapDecoder::initFromBuffer(const char *, unsigned long) --> void", pybind11::arg("buffer"), pybind11::arg("size"));
...
// File: mmtf/msgpack_decoders.cpp
#include <functional> // std::less
#include <iterator> // __gnu_cxx::__normal_iterator
#include <map> // std::_Rb_tree_const_iterator
#include <map> // std::_Rb_tree_iterator
...
#include <memory> // std::allocator
#include <mmtf/map_decoder.hpp> // mmtf::MapDecoder
#include <mmtf/msgpack_decoders.hpp> // mmtf::impl::decodeFromMapDecoder
#include <mmtf/structure_data.hpp> // mmtf::BioAssembly
#include <mmtf/structure_data.hpp> // mmtf::Entity
#include <mmtf/structure_data.hpp> // mmtf::GroupType
#include <mmtf/structure_data.hpp> // mmtf::StructureData
...
void bind_mmtf_msgpack_decoders(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	// mmtf::impl::decodeFromMapDecoder(struct mmtf::StructureData &, class mmtf::MapDecoder &) file:mmtf/msgpack_decoders.hpp line:26
	M("mmtf::impl").def("decodeFromMapDecoder", (void (*)(struct mmtf::StructureData &, class mmtf::MapDecoder &)) &mmtf::impl::decodeFromMapDecoder, "C++: mmtf::impl::decodeFromMapDecoder(struct mmtf::StructureData &, class mmtf::MapDecoder &) --> void", pybind11::arg("data"), pybind11::arg("md"));

}


// File: mmtf/decoder.cpp
#include <fstream> // std::basic_filebuf
#include <fstream> // std::basic_ifstream
#include <functional> // std::less
#include <ios> // std::_Ios_Openmode
...
#include <map> // std::map
#include <memory> // std::allocator
#include <mmtf/decoder.hpp> // mmtf::decodeFromBuffer
#include <mmtf/decoder.hpp> // mmtf::decodeFromFile
#include <mmtf/decoder.hpp> // mmtf::decodeFromMapDecoder
#include <mmtf/decoder.hpp> // mmtf::mapDecoderFromBuffer
#include <mmtf/decoder.hpp> // mmtf::mapDecoderFromFile
#include <mmtf/decoder.hpp> // mmtf::mapDecoderFromStream
#include <mmtf/map_decoder.hpp> // mmtf::MapDecoder
#include <mmtf/structure_data.hpp> // mmtf::BioAssembly
#include <mmtf/structure_data.hpp> // mmtf::Entity
#include <mmtf/structure_data.hpp> // mmtf::GroupType
...
{
	// mmtf::decodeFromMapDecoder(struct mmtf::StructureData &, class mmtf::MapDecoder &) file:mmtf/decoder.hpp line:34
	M("mmtf").def("decodeFromMapDecoder", (void (*)(struct mmtf::StructureData &, class mmtf::MapDecoder &)) &mmtf::decodeFromMapDecoder, "Decode an MMTF data structure from a mapDecoder.\n \n\n   MMTF data structure to be filled\n \n\n MapDecoder holding raw mmtf data\n \n\n mmtf::DecodeError if an error occured\n\nC++: mmtf::decodeFromMapDecoder(struct mmtf::StructureData &, class mmtf::MapDecoder &) --> void", pybind11::arg("data"), pybind11::arg("mapDecoder"));

	// mmtf::decodeFromBuffer(struct mmtf::StructureData &, const char *, unsigned long) file:mmtf/decoder.hpp line:43
	...
	// mmtf::decodeFromFile(struct mmtf::StructureData &, const std::string &) file:mmtf/decoder.hpp line:66
	...
	// mmtf::mapDecoderFromBuffer(class mmtf::MapDecoder &, const char *, unsigned long) file:mmtf/decoder.hpp line:75
	M("mmtf").def("mapDecoderFromBuffer", (void (*)(class mmtf::MapDecoder &, const char *, unsigned long)) &mmtf::mapDecoderFromBuffer, "Get a mapDecoder for un-decoded MMTF data\n \n\n  MapDecoder to hold raw mmtf data\n\n Other parameters and behavior are as in ::decodeFromBuffer, but this doesn't\n decode the MMTF content.\n\nC++: mmtf::mapDecoderFromBuffer(class mmtf::MapDecoder &, const char *, unsigned long) --> void", pybind11::arg("mapDecoder"), pybind11::arg("buffer"), pybind11::arg("size"));

	// mmtf::mapDecoderFromStream(class mmtf::MapDecoder &, class std::basic_ifstream<char> &) file:mmtf/decoder.hpp line:132
	M("mmtf").def("mapDecoderFromStream", (void (*)(class mmtf::MapDecoder &, class std::basic_ifstream<char> &)) &mmtf::mapDecoderFromStream<std::basic_ifstream<char>>, "C++: mmtf::mapDecoderFromStream(class mmtf::MapDecoder &, class std::basic_ifstream<char> &) --> void", pybind11::arg("mapDecoder"), pybind11::arg("stream"));

	// mmtf::mapDecoderFromFile(class mmtf::MapDecoder &, const std::string &) file:mmtf/decoder.hpp line:95
	M("mmtf").def("mapDecoderFromFile", (void (*)(class mmtf::MapDecoder &, const std::string &)) &mmtf::mapDecoderFromFile, "Get a mapDecoder into an un-decoded MMTF data\n \n\n  MapDecoder to hold raw mmtf data\n\n Other parameters and behavior are as in ::decodeFromFile, but this doesn't\n decode the MMTF content.\n\nC++: mmtf::mapDecoderFromFile(class mmtf::MapDecoder &, const std::string &) --> void", pybind11::arg("mapDecoder"), pybind11::arg("filename"));

}


// File: mmtf/binary_encoder.cpp
#include <fstream> // std::basic_filebuf
#include <fstream> // std::basic_ofstream
#include <functional> // std::less
#include <ios> // std::_Ios_Openmode
...
#include <map> // std::map
#include <memory> // std::allocator
#include <mmtf/binary_encoder.hpp> // mmtf::encodeDeltaRecursiveFloat
#include <mmtf/binary_encoder.hpp> // mmtf::encodeFourByteInt
#include <mmtf/binary_encoder.hpp> // mmtf::encodeInt8ToByte
#include <mmtf/binary_encoder.hpp> // mmtf::encodeRunLengthChar
#include <mmtf/binary_encoder.hpp> // mmtf::encodeRunLengthDeltaInt
#include <mmtf/binary_encoder.hpp> // mmtf::encodeRunLengthFloat
#include <mmtf/binary_encoder.hpp> // mmtf::encodeRunLengthInt8
#include <mmtf/binary_encoder.hpp> // mmtf::encodeStringVector
#include <mmtf/encoder.hpp> // mmtf::encodeToFile
#include <mmtf/encoder.hpp> // mmtf::encodeToMap
#include <mmtf/encoder.hpp> // mmtf::encodeToStream
#include <mmtf/structure_data.hpp> // mmtf::StructureData
#include <string> // std::__cxx11::basic_string
#include <string> // std::char_traits
#include <utility> // std::pair
...
{
	// mmtf::encodeInt8ToByte(class std::vector<signed char, class std::allocator<signed char> >) file:mmtf/binary_encoder.hpp line:95
	...
	// mmtf::encodeFourByteInt(class std::vector<int, class std::allocator<int> >) file:mmtf/binary_encoder.hpp line:101
	...
	// mmtf::encodeRunLengthInt8(class std::vector<signed char, class std::allocator<signed char> >) file:mmtf/binary_encoder.hpp line:142
	...
	// mmtf::encodeToFile(const struct mmtf::StructureData &, const std::string &, int, int, int) file:mmtf/encoder.hpp line:36
	...
	// mmtf::encodeToStream(const struct mmtf::StructureData &, class std::basic_ofstream<char> &, int, int, int) file:mmtf/encoder.hpp line:51
...
// File: mmtf/custom_zone_type_binding.cpp
#include <iterator> // __gnu_cxx::__normal_iterator
#include <memory> // std::allocator
#include <mmtf/custom_zone_type_binding.hpp> // mmtf::stupid
#include <mmtf/structure_data.hpp> // mmtf::StructureData
#include <string> // std::__cxx11::basic_string
#include <string> // std::char_traits
#include <vector> // std::vector
...
void bind_mmtf_custom_zone_type_binding(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	// mmtf::stupid() file:mmtf/custom_zone_type_binding.hpp line:139
	M("mmtf").def("stupid", (struct mmtf::StructureData (*)()) &mmtf::stupid, "C++: mmtf::stupid() --> struct mmtf::StructureData");
...
PYBIND11_MODULE(mmtf_cpp, root_module) {
	...
	bind_mmtf_msgpack_decoders(M);
	bind_mmtf_decoder(M);
	bind_mmtf_binary_encoder(M);
	bind_mmtf_custom_zone_type_binding(M);

}

// Source list file: /home/danpf/git/binder/examples/mmtf_example_scratch/cmake_bindings/mmtf_cpp.sources
// mmtf_cpp.cpp
// std/exception.cpp
// std/postypes.cpp
...
// mmtf/errors.cpp
// mmtf/structure_data.cpp
// mmtf/binary_decoder.cpp
// mmtf/msgpack_decoders.cpp
// mmtf/decoder.cpp
// mmtf/binary_encoder.cpp
// mmtf/custom_zone_type_binding.cpp

// Modules list file: /home/danpf/git/binder/examples/mmtf_example_scratch/cmake_bindings/mmtf_cpp.modules
// mmtf mmtf.impl std 
