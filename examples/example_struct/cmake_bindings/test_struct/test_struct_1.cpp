...
void bind_test_struct_test_struct_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // testers::test_my_struct file:test_struct/test_struct.hpp line:21
